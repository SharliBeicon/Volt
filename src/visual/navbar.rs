use eframe::egui;
use egui::{include_image, pos2, Align2, Color32, FontFamily, FontId, Image, Margin, Rect, Stroke, Ui};
        ...
        egui::Frame::default()
            ...
            .show(ui, |ui| {
                egui::Frame::default().show(ui, |ui| {
                    ui.painter().line_segment([pos2(300., 50.), pos2(viewport.width(), 50.)], Stroke::new(0.5, theme.navbar_outline));
                    egui::Frame::default()
                        .fill(theme.navbar)
                        .inner_margin(Margin {
                            left: 5.,
                        ...
                        .show(ui, |ui| {
                            ui.with_layout(egui::Layout::left_to_right(egui::Align::Center), |ui| {
                                egui::Frame::default().fill(theme.navbar).show(ui, |ui| {
                                    ui.add(Image::new(include_image!("../images/icons/icon.png")).max_width(40.).max_height(40.));
                                    egui::Frame::default()
                                        .fill(theme.navbar)
                                        .inner_margin(Margin {
                                            left: 5.,
